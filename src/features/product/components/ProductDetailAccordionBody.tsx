...
import type { ProductAccordionSection } from "@/features/product/utils/productDetailAccordion";

import { PDP_BODY_TEXT_CLASS } from "../constants/productDetail.constants";
