...
import { PRODUCT_DETAIL_DISCLAIMER } from "@/features/product/mocks/detail.mock";



import { PDP_HORIZONTAL_PADDING, PDP_SUBTITLE_CLASS } from "../constants/productDetail.constants";
